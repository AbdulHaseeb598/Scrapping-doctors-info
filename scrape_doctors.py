...
"""
Playwright-only Marham scraper (final corrected version)
--------------------------------------------------------
✅ Fixes misalignment of 'experience' appearing under 'reviews' column.
✅ Keeps all original functionality (timings, pagination, resume, labels, etc.)
✅ No BeautifulSoup / no requests — Playwright only.

Usage:
    pip install playwright
    python -m playwright install chromium
    python scrape_doctors_playwright_final_full_fixed.py
"""
